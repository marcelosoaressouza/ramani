class EntidadesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @entidade.save
        ...
        format.json { render action: 'show', status: :created, location: @entidade }
      else
  ...
  private
    ...
    def entidade_params
      params.require(:entidade).permit(:name, :description, :address, :city, :state, :country, :latitude, :longitude)
    end
end
